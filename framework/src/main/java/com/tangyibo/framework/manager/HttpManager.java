...
import com.tangyibo.framework.utils.HashUtils;
...
public class HttpManager {
    ...
    public String postCloudToken(HashMap<String, String> map) {
        ...
        String Signature = HashUtils.sha1(RongCloudManager.RongCloud_SECRET + Nonce + Timestamp);
        ...
        Request request = new Request.Builder()
                .url(RongCloudManager.TOKEN_URL)
                .addHeader("Timestamp", Timestamp)
                .addHeader("App-Key", RongCloudManager.RongCloud_KEY)
