package com.tangyibo.framework.tag;
...
public class TagCloudView extends ViewGroup implements Runnable, TagAdapter.OnDataSetChangeListener {
    ...
    private TagAdapter tagsAdapter = new NOPTagsAdapter();
