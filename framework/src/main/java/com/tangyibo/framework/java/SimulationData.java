package com.tangyibo.framework.java;
...
public class SimulationData {
    ...
    private static final String[] mGirlName = {"灯下绘千秋", "沸雪灼", "月色入喉", "不吃香菜", "偏执的傲", "半呆半萌半幼稚", "蠢萌蠢萌的二货", "我不愿意种花", "万里"
            , "白鹭洲", "宅久天然呆", "知你霜雪催", "不知沉醉", "Rose·Nebula", "我说橘子真好吃", "牛崽与發财", "懵懂的幼稚", "snow", "拨打寂寞专线", "星期八再约", "uɐuɐʍ"
            , "iipepsii", "青山", "给我一桶popcorn", "草莓棉花糖", "星月故里", "懒", "单色冰淇淋", "yumoko", "8oboom", "天生萌货", "幸运符号"
            , "pwpoo", "宴请八仙", "灬vov灬", "斩清秋", "方仒其斤", "闭眼", "化鹤来", "万花丛中我最拽", "颦眉", "洛雪", "萌小喵", "辛德瑞拉", " の酱酱酱>=<", "雾绕空山"
            , "momoko", "大大大大太阳", "ooqpoo", "软酱奶糖", "我迷了鹿", "大檬檬 "};
    ...
    private static final String[] mBoyName = {"故人何必念情", "只谈情不闲聊", "是光", "是我闯入你的生活", "accept", "早冬一棵树", "睡不醒",
            "待我发光闪瞎你", "你可以滚了", "li-rmo", "我在熬夜 熟了叫你", "ddd", "宁无拥人", "穿裤子的云", "奇迹少年", "温柔一只鬼", "需索", "淡奶油", "小杨不放羊",
            "稍纵即逝", "局外人", "噬月者", "贰时。", "藤", "人海一粒渣", "铁树不开花", "Carrl", "世俗", "退到无路可退", "香菜麻麻香", "宁采臣",
            "海的那边", "自甘堕落", "coco", "脸红派", "软肋", "禁忌", "触碰岁月", "一派天真", "探测极限", "绊绊绊绊死你", "富富得郑", "茶理芝士球",
            "陪你浪迹天涯", "烦人精", "寄来匿名信", "胡图图", "一身可爱味", "在海边捡1束花", "安守", "three", "怎忧"};
