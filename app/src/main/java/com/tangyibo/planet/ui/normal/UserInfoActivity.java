package com.tangyibo.planet.ui.normal;
...
import com.tangyibo.planet.model.UserInfoModel;
...
public class UserInfoActivity extends BaseActivity implements View.OnClickListener{
    ...
    //个人信息颜色
    private int[] mColor = {0x1A1E90FF, 0x1A00FF7F, 0x1AFFD700, 0x1AFF6347, 0x1AF08080, 0x1A40E0D0};

    //用户ID
    private String userId = "";

    private PlanetUser imUser;
    ...
    private void queryUserInfo() {
        ...
        //查询用户信息
        BmobManager.getInstance().queryObjectIdUser(userId, new FindListener<PlanetUser>() {
            @Override
     ...
     * @param imUser
     */
    private void updateUserInfo(PlanetUser imUser) {
        //设置基本属性
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            case R.id.tv_add_friend:
                ...
                RongCloudManager.getInstance().sendTextMessage(msg,
                        RongCloudManager.TYPE_ADD_FRIEND, userId);
            ...
            case R.id.btn_audio_chat:
                ...
                if (!checkWindowPermissions()) {
                    ...
                    RongCloudManager.getInstance().startAudioCall(this, userId);
                }
                break;
            case R.id.btn_video_chat:
                if (!checkWindowPermissions()) {
                    ...
                    RongCloudManager.getInstance().startVideoCall(this, userId);
                }
                break;
        }
    }
