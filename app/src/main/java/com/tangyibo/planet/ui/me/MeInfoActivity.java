...
import com.tangyibo.framework.view.DatePickerTheme;
...
public class MeInfoActivity extends BaseBackActivity implements View.OnClickListener {
    ...
    private void initAgeDialog() {
        ...
        mAgeAdapter = new CommonAdapter<>(mAgeList, new CommonAdapter.OnBindDataListener<Integer>() {
            @Override
            public void onBindViewHolder(final Integer model, CommonViewHolder viewHolder, int type, int position) {
                viewHolder.setText(R.id.tv_age_text, model + "");
    ...
    private void initPhotoDialog() {
        ...
        tv_camera.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                FileManager.getInstance().toCamera(MeInfoActivity.this);
            }
        });
        tv_ablum.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DialogManager.getInstance().hide(mPhotoDialog);
                FileManager.getInstance().toAlbum(MeInfoActivity.this);
            }
        });
                ...
                if (e == null) {
                    if (CommonUtils.isEmpty(list)) {
                        ...
                        if (!TextUtils.isEmpty(imUser.getPhoto())) {
                            GlideHelper.loadUrl(MeInfoActivity.this, imUser.getPhoto(), iv_user_photo);
                        }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.menu_save) {
            final PlanetUser imUser = BmobManager.getInstance().getUser();
     ...
     * @param imUser
     */
    private void updateUser(PlanetUser imUser) {
        //名称不能为空
            ...
            if (requestCode == FileManager.CAMEAR_REQUEST_CODE) {
                ...
                if (uri != null) {
                    ...
                    if (!TextUtils.isEmpty(path)) {
                        ...
                        FileManager.getInstance().startPhotoZoom(this, uploadPhotoFile);
                    }
                }
            } else if (requestCode == FileManager.CAMERA_CROP_RESULT) {
                uploadPhotoFile = new File(FileManager.getInstance().getCropPath());
